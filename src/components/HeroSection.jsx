  ...
  return (
    ...
    >
      <div className="flex lg:gap-10 md:gap-5 justify-center m-5 md:my-10">
        <img src={hero3} alt="image 1" className="rounded-2xl object-fill aspect-[16/9] lg:w-[80%]" />
      </div>
      <div className="flex lg:gap-10 md:gap-5 justify-center m-5 md:my-10">
        <img src={hero4} alt="image 2" className="rounded-2xl object-fill aspect-[16/9] lg:w-[80%]" />
      </div>
    </Carousel>
  );
}
