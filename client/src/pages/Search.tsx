...
export default function SearchPage() {
  ...
  const trendingResults: TMDBItem[] = trending?.results?.filter(
    (item: TMDBItem) => item.media_type !== 'person'
  ) || [];
      ...
      <div className="pt-24 pb-8">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative">
            ...
            />
            {input && (
              <button onClick={() => { setInput(''); setSearchParams({}); }} className="absolute right-4 top-1/2 -translate-y-1/2">
              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-20 p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {history.map((h: string, i: number) => (
                    <button
                      key={i}
                      onMouseDown={() => { setInput(h); setShowHistory(false); }}
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        ...
        {query && !isLoading && results.length === 0 && (
          <div className="text-center py-16">
            ...
            <h2 className="text-xl font-semibold text-gray-600">No results found for &ldquo;{query}&rdquo;</h2>
        ...
        {query && !isLoading && results.length > 0 && (
          <>
            <p className="text-sm text-gray-500 mb-6">{data?.total_results} results for &ldquo;{query}&rdquo;</p>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
